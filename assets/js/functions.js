...
$(document).ready(function() {
    ...
    (function() {
        ...
        //Ocultando menu al ser menor a 992px
        function ocultar(){
    ...
    if (!$('html').hasClass('ismobile')) {
        if (!$('.login-content')[0]) {
            scrollbar('html', 'rgba(0,0,0,0.3)', '8px');
        }

        //Scrollbar Tables
        if ($('.table-responsive')[0]) {
            scrollbar('.table-responsive', 'rgba(0,0,0,0.5)', '8px');
        }

        //Scrill bar for Chosen
        if ($('.chosen-results')[0]) {
            scrollbar('.chosen-results', 'rgba(0,0,0,0.5)', '8px');
        }
        ...
        //Scrollbar for rest
        if ($('.c-overflow')[0]) {
            scrollbar('.c-overflow', 'rgba(0,0,0,0.5)', '8px');
        }
    }
    ...
    if(typeof idiomas == 'function'){ idiomas(); }
    if(typeof empezar == 'function'){ empezar(); }
    //if(carga){carga.finish();}
    if(window['carga']){carga.finish();}
});